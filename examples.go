...
func ExampleScene1Opts(width, height int) *RenderOptions {
	return &RenderOptions{
		...
		Spheres: []*Sphere{
			...
			{Center: Vec3{X: 0, Y: 0, Z: -5}, Radius: 1.0, Material: Material{Color: RGB(0.8, 0.2, 0.2), Reflectivity: 0.9, Transparency: 0.9, RefractiveIndex: 1.5}},
			...
			// Ground plane
			{Center: Vec3{X: 0, Y: -1001, Z: -5}, Radius: 1000.0, Material: Material{Color: RGB(0.8, 0.8, 0.8)}},
		},
		Lights: []*Light{
